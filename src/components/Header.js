...
export default function Header() {
    ...
    return (
        <header className="bg-white dark:bg-gray-900 shadow-sm border-b border-gray-100 dark:border-gray-800 fixed w-full top-0 z-40 transition-colors duration-150">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <Link href="/" className="flex flex-row items-center gap-2">
                        ...
                        <span className="text-[25px] font-bold text-gray-900 dark:text-white">axto.ai</span>
                    </Link>
                    ...
                    <div className="hidden lg:flex items-center gap-3">
                        ...
                        {isAuthenticated ? (
                            ...
                            <Link
                                href="/login"
                                className="group relative inline-flex items-center justify-center gap-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold px-4 py-2.5 rounded-xl shadow-2xl hover:shadow-purple-500/30 transform hover:scale-[1.0] transition-all duration-300 overflow-hidden"
                            >
